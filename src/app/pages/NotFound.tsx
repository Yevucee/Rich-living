...
export default function NotFound() {
  return (
    <div className="bg-off-white min-h-screen flex items-center justify-center px-6">
      <div className="text-center max-w-2xl">
        <div className="mb-8">
          <span className="font-heading text-9xl md:text-[12rem] text-navy/10">404</span>
        </div>
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-center">
          <Link
            to="/"
            className="px-8 py-4 bg-navy text-off-white hover:bg-navy-light transition-colors"
          >
            Go to Homepage
          </Link>
          <Link
        ...
        <div className="mt-12 pt-12 border-t border-border">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center items-center text-sm">
            <a
              ...
              className="text-gold hover:text-gold-dark transition-colors flex items-center gap-2"
            >
